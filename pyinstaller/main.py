...
class AboutWindow(QTabWidget):
	def __init__(self, parent=None):
		...
		self.setWindowIcon(QIcon(resource_path('img/info.png')))
...
class MainWindow(QMainWindow):
	...
	class FormWidget(QWidget):
		def initUI(self, parent):
			...
			setpointRefreshButton = PicButton(QPixmap(resource_path("img/refresh.png")), QPixmap(resource_path("img/refresh_hover.png")), QPixmap(resource_path("img/refresh_pressed.png")))
			setpointRefreshButton.clicked.connect(self.setpointRefresh)
			setpointRefreshButton.setIcon(QIcon(resource_path("img/refresh.png")))
			...
			KpRefreshButton = PicButton(QPixmap(resource_path("img/refresh.png")), QPixmap(resource_path("img/refresh_hover.png")), QPixmap(resource_path("img/refresh_pressed.png")))
			KpRefreshButton.clicked.connect(self.KpRefresh)
			KpRefreshButton.setIcon(QIcon(resource_path("img/refresh.png")))
			...
			KiRefreshButton = PicButton(QPixmap(resource_path("img/refresh.png")), QPixmap(resource_path("img/refresh_hover.png")), QPixmap(resource_path("img/refresh_pressed.png")))
			KiRefreshButton.clicked.connect(self.KiRefresh)
			KiRefreshButton.setIcon(QIcon(resource_path("img/refresh.png")))
			...
			KdRefreshButton = PicButton(QPixmap(resource_path("img/refresh.png")), QPixmap(resource_path("img/refresh_hover.png")), QPixmap(resource_path("img/refresh_pressed.png")))
			KdRefreshButton.clicked.connect(self.KdRefresh)
			KdRefreshButton.setIcon(QIcon(resource_path("img/refresh.png")))
